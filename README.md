...
- [Tokens Forge](https://tokens-forge.com/) - OpenAI-compatible multi-model API platform for GPT, Claude, and Gemini with token balances, usage ledgers, starter credit, and an AI trading research assistant.
