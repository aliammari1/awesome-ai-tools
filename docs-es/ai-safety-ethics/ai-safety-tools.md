...
- **Description**: El conjunto de herramientas de equidad de IBM.
- **Pricing**: 🆓

### What-If Tool
- **Website**: [https://pair-code.github.io/what-if-tool/](https://pair-code.github.io/what-if-tool/)
- **Description**: La herramienta de interpretabilidad de ML de Google.
- **Pricing**: 🆓

### LIME
- **Website**: [https://github.com/marcotcr/lime](https://github.com/marcotcr/lime)
- **Description**: Explicaciones de modelos interpretables locales.
- **Pricing**: 🆓

### SHAP
- **Website**: [https://github.com/slundberg/shap](https://github.com/slundberg/shap)
- **Description**: Explica los modelos de aprendizaje automático.
- **Pricing**: 🆓
