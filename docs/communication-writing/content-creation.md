...
- **Description**: AI writing, Q&A, and agentic workflows with GPT-5 integration (Nov 2025).
- **Pricing**: 💰

### Google Workspace Studio
- **Website**: [https://workspace.google.com/studio](https://workspace.google.com/studio)
- **Description**: No-code AI agent builder for enterprise automation (Dec 2025).
- **Pricing**: 🆓/💰

### Lex
- **Website**: [https://lex.page/](https://lex.page/)
- **Description**: AI-powered word processor for writers.
- **Pricing**: 🆓/💰
