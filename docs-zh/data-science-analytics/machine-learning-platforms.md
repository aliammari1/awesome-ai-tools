...
- **Description**: 具有 AI 代理系统和 10.0 版本功能的自动化机器学习平台。
- **Pricing**: 💰

### H2O.ai
- **Website**: [https://www.h2o.ai/](https://www.h2o.ai/)
- **Description**: 具有 h2oGPT 和文档人工智能的开源机器学习和人工智能平台。
- **Pricing**: 🆓/💰

### AutoML by Google Cloud
- **Website**: [https://cloud.google.com/automl/](https://cloud.google.com/automl/)
- **Description**: 谷歌的 AutoML 套件，集成了 Vertex AI 和 Gemini。
- **Pricing**: 💰
